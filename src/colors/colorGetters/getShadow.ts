export const getThemeShadowsWithColors = (
  primaryColor: string,
  darkMode: boolean
) => {
  ...
  const shadowsStaticDarkMode = {
    basic: "0px 1px 0px rgba(20, 20, 26, 0.33), 0px 24.6907px 38px 7px rgba(21, 18, 24, 0.28), 0px 11.5156px 21.5219px -4px rgba(21, 16, 27, 0.4), inset 0px -1px 1px rgba(24, 20, 29, 0.38)",
