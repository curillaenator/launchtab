import React, { forwardRef, useState, useRef, useCallback, type ChangeEvent, type HTMLAttributes } from 'react';
...
export const Input = forwardRef<HTMLInputElement, ITextInput>((props) => {
  const {
    state = 'normal',
    iconName,
    type = 'text',
