...
const COLOR_ITEMS: DropdownItemProps<TextColorCommand>[] = [
  {
    id: 'defaultColor',
    Icon: BlackCharIcon,
...
const BACKGROUND_COLOR_ITEMS: DropdownItemProps<TextColorCommand>[] = [
  {
...
const TEXT_COLOR_CLEAR: DropdownItemProps<TextColorAndHighlightClear> = {
  id: 'textColorClear',
  Icon: BlackCharIcon,
  command: (chain) => chain.focus().unsetColor().run(),
};

const TEXT_HIGHLIGHT_CLEAR: DropdownItemProps<TextColorAndHighlightClear> = {
...
const TEXT_COLOR_AND_HIGHLIGHT_CLEAR: DropdownItemProps<TextColorAndHighlightClear> = {
